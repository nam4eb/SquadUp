...
class _ActivityFeedWidgetState extends State<ActivityFeedWidget> {
  // TODO: Replace with Riverpod ActivitiesProvider for production
  final List<Map<String, dynamic>> _activityMaps = [
    ...
    },
    {
      ...
      'coverUrl':
          'https://images.pixabay.com/photo/2017/08/10/14/17/beer-2619862_640.jpg',
      'coverLabel':
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Image Hero top — V5 Card anatomy LOCKED
            Stack(
              children: [
                ClipRRect(
